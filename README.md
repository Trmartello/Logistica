...
- **Ordenação**: clique no cabeçalho de qualquer coluna para alternar crescente/decrescente (no celular, use o painel ⚙️).
- No computador a tela ocupa a largura inteira; no celular a lista vira cartões.
